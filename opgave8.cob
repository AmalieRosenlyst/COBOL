      * Formål: Læsning af flere filer og skriv i output fil. 
       ...
       SELECT OUTPUT-FILE ASSIGN TO "customers-w-account.txt"
       ORGANIZATION IS LINE SEQUENTIAL.
      ...
      * Check if customer has an account
                   PERFORM UNTIL END-OF-FILE2 = "Y" 
                       READ INPUT-ACCOUNTS INTO ACCOUNT-RECORD
                           ...
                           NOT AT END 
                               IF client-id OF ACCOUNT-RECORD = 
                               client-id OF CUSTOMER-RECORD THEN 
      ...
      * Reset accounts file for next customer
